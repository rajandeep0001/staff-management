	...
	<div id="main"><br/>
		<div id="main" style="text-align:Center;">
   		...
   		<table id="tab2"  style="text-align:left;">
      		<tbody>
				<tr>
					<td colspan="5"><h3>Thesis Information</h3></td>
				</tr>
        		<tr>
        		...
        		<tr>
          			<td><h3>Name:</h3></td>
          			<td>
							<input type="text" name="name" class="etxt2"   />
          			...
          			<td>
							<input type="text" name="supervisor" class="txt2"   />
...
if(isset($_POST['save']))
{
	...
	$sql="insert into thesis_guided values(null,'".$username."','".$title."','".$name
		."','".$supervisor"','".$year."')";
