   		...
   		<table id="tab2"  style="text-align:left;">
      		<tbody>
        		...
        		<tr>
          			...
          			<td>
							<input type="text" name="organisation" class="txt2" value="<?php echo $row[2]; ?>"  />
...
if(isset($_POST['save']))
{
				...
				$sql="UPDATE research SET title = '".$title."', organization = '".$organization."', year ='".$year."' WHERE  username='".$_SESSION['username']."'";
