...
<map name="Map" id="Map">
  ...
  <div id="photo"><img src="images/10.jpg" width="300" height="347" /></div>
...
$sql="SELECT * FROM profile where id='7'";
...
?>
    ...
    <p align="left" class="style2"><a name="CSWS" id="CSWS">Conferences/Seminars/Winter/Summer Schools Attended
    (Last 3 Years)</a></p>
